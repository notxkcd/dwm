 ...
 *
 * The event handlers of organized in an array which is accessed
...
static int bh = 2, blw = 0;      /* bar geometry */
  ...
  if (display != NULL) {
    ...
    if (resm != NULL) {
      ...
      if (xrdb != NULL) {
        ...
        XRDB_LOAD_COLOR("color15", normfgcolor);
        XRDB_LOAD_COLOR("color15", selfgcolor);
